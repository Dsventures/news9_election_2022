function drawAssemblyMap(selector, settings) {
  ...
  if (settings.type === "generic") {
    ...
    var tool_tip = d3
      ...
      .offset([120, 140])
      .html(function (d) {
        var fdFillData = constwisetrenddata2017["mapdata"].filter(function (
          r,
          j
        ) {
        ...
        html +=
          '<span style="color:' +
          alliance_colorList["2012"][year2012] +
          '">' +
          year2012 +
          "</span>";
        html += "</div>";
        ...
        html +=
          '<span style="color:' +
          alliance_colorList["2017"][year2017] +
          '">' +
          year2017 +
          "</span>";
        html += "</div>";
  ...
  d3.json(source, function (error, stateShape) {
    ...
    var stateconst = topojson.feature(
      stateShape,
      stateShape.objects.collection
    ).features;
    ...
    if (settings.type === "generic") {
      ...
      //     return parseInt(r.constNo) === d.properties.ac;
      //   });
      //   return alliance_colorList[
      //     settings.year
      //   ][fdFillData[0]["party" + settings.year]];
      // });
    }
    ...
    var legendData = constwisetrenddata2017["mapdata"]
      .map(function (t) {
    ...
    var legendItem = legendCont
      ...
      .html(function (d) {
        var html =
          ...
          alliance_colorList[settings.year][d] +
